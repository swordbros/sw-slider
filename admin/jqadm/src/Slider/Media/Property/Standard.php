...
namespace Aimeos\Admin\JQAdm\Slider\Media\Property;
...
{
	/** admin/jqadm/slider/media/property/name
	 * Name of the property subpart used by the JQAdm slider media implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Slider\Media\Property\Myname".
	...
	{
		/** admin/jqadm/slider/media/property/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/slider/media/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/slider/media/property/decorators/global
		 * @see admin/jqadm/slider/media/property/decorators/local
		 */

		/** admin/jqadm/slider/media/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/slider/media/property/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/slider/media/property/decorators/excludes
		 * @see admin/jqadm/slider/media/property/decorators/local
		 */

		/** admin/jqadm/slider/media/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/slider/media/property/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/slider/media/property/decorators/global
		 */
		return $this->createSubClient( 'slider/media/property/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/slider/media/property/standard/subparts
		 * List of JQAdm sub-clients rendered within the slider media property section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/slider/media/property/standard/subparts', [] );
	}
	...
	{
		/** admin/jqadm/slider/media/property/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/slider/media/property/template-item';
		$default = 'slider/item-media-property-standard';
