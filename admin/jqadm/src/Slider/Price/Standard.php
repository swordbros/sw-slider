...
namespace Aimeos\Admin\JQAdm\Slider\Price;
...
{
	/** admin/jqadm/slider/price/name
	 * Name of the price subpart used by the JQAdm slider implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Slider\Price\Myname".
	...
	public function addData( \Aimeos\MW\View\Iface $view ) : \Aimeos\MW\View\Iface
	{
		...
		$search->setConditions( $search->compare( '==', 'price.type.domain', 'slider' ) );
		$search->setSortations( [$search->sort( '+', 'price.type.position' )] );

		$listSearch = $listTypeManager->createSearch( true )->setSlice( 0, 10000 );
		$listSearch->setConditions( $listSearch->compare( '==', 'slider.lists.type.domain', 'price' ) );
	...
	{
		/** admin/jqadm/slider/price/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/slider/price/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/slider/price/decorators/global
		 * @see admin/jqadm/slider/price/decorators/local
		 */

		/** admin/jqadm/slider/price/decorators/global
		 ...
		 *
		 *  admin/jqadm/slider/price/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/slider/price/decorators/excludes
		 * @see admin/jqadm/slider/price/decorators/local
		 */

		/** admin/jqadm/slider/price/decorators/local
		 ...
		 *
		 *  admin/jqadm/slider/price/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/slider/price/decorators/global
		 */
		return $this->createSubClient( 'slider/price/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/slider/price/standard/subparts
		 * List of JQAdm sub-clients rendered within the slider price section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/slider/price/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Slider\Item\Iface $item, array $data ) : \Aimeos\MShop\Slider\Item\Iface
	{
		...
		foreach( $data as $idx => $entry )
		{
			if( ( $listItem = $item->getListItem( 'price', $entry['slider.lists.type'], $entry['price.id'], false ) ) === null ) {
	...
	{
		/** admin/jqadm/slider/price/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/slider/price/template-item';
		$default = 'slider/item-price-standard';
