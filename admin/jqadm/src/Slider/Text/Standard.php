...
namespace Aimeos\Admin\JQAdm\Slider\Text;

sprintf( 'text' ); // for translation


/**
 * Default implementation of slider text JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/slider/text/name
	 * Name of the text subpart used by the JQAdm slider implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Slider\Text\Myname".
	...
	{
		/** admin/jqadm/slider/text/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/slider/text/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/slider/text/decorators/global
		 * @see admin/jqadm/slider/text/decorators/local
		 */

		/** admin/jqadm/slider/text/decorators/global
		 ...
		 *
		 *  admin/jqadm/slider/text/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/slider/text/decorators/excludes
		 * @see admin/jqadm/slider/text/decorators/local
		 */

		/** admin/jqadm/slider/text/decorators/local
		 ...
		 *
		 *  admin/jqadm/slider/text/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/slider/text/decorators/global
		 */
		return $this->createSubClient( 'slider/text/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/slider/text/standard/subparts
		 * List of JQAdm sub-clients rendered within the slider text section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/slider/text/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Slider\Item\Iface $item, array $data ) : \Aimeos\MShop\Slider\Item\Iface
	{
		...
		foreach( $data as $idx => $entry )
		{
			...
			if( ( $listItem = $item->getListItem( 'text', $entry['slider.lists.type'], $entry['text.id'], false ) ) === null ) {
	...
	{
		/** admin/jqadm/slider/text/template-item
		 * Relative path to the HTML body template of the text subpart for sliders.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/slider/text/template-item';
		$default = 'slider/item-text-standard';
