	...
	implements \Aimeos\MShop\Slider\Provider\Delivery\Iface
{
	...
	private $beConfig = [
		...
		'xml.template' => [
			...
			'type' => 'string',
			'internaltype' => 'string',
			'default' => 'slider/provider/delivery/xml-body-standard',
			'required' => false,
		],
		'xml.updatedir' => [
			'code' => 'xml.updatedir',
	 ...
	 * @return \Aimeos\MShop\Slider\Provider\Delivery\Iface Same object for fluent interface
	 */
	protected function createFile( string $content ) : \Aimeos\MShop\Slider\Provider\Delivery\Iface
	{
	...
	protected function createXml( array $orderItems, array $baseItems ) : string
	{
		...
		$template = $this->getConfigValue( 'xml.template', 'slider/provider/delivery/xml-body-standard' );
	...
	{
		$ids = [];
		$ref = ['order/base/address', 'order/base/coupon', 'order/base/product', 'order/base/slider'];
	 ...
	 * @return \Aimeos\MShop\Slider\Provider\Delivery\Iface Same object for fluent interface
	 */
	protected function importFile( string $filename ) : \Aimeos\MShop\Slider\Provider\Delivery\Iface
	{
		$nodes = [];
		$xml = new \XMLReader();
	 ...
	 * @return \Aimeos\MShop\Slider\Provider\Delivery\Iface Same object for fluent interface
	 */
	protected function importNodes( array $nodes ) : \Aimeos\MShop\Slider\Provider\Delivery\Iface
	{
