...
abstract class Base extends \Aimeos\MShop\Slider\Provider\Base implements Iface
{
	...
	{
		throw new \Aimeos\MShop\Slider\Exception( sprintf( 'Method "%1$s" for provider not available', 'cancel' ) );
	}
	...
	{
		throw new \Aimeos\MShop\Slider\Exception( sprintf( 'Method "%1$s" for provider not available', 'capture' ) );
	}
	...
	{
		throw new \Aimeos\MShop\Slider\Exception( sprintf( 'Method "%1$s" for provider not available', 'refund' ) );
	}
	...
	{
		throw new \Aimeos\MShop\Slider\Exception( sprintf( 'Method "%1$s" for provider not available', 'repay' ) );
	}
	...
	{
		return $this->setAttributes( $orderSliderItem, $attributes, 'payment' );
	}
}
