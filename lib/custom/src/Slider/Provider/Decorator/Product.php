...
/**
 * Product-limiting decorator for slider providers
 *
	...
	implements \Aimeos\MShop\Slider\Provider\Decorator\Iface
{
	private $beConfig = array(
		'product.include' => array(
			...
			'label' => 'Codes of allowed products for the slider item',
			'type' => 'string',
			'internaltype' => 'string',
			'default' => '',
			'required' => false,
		...
		'product.exclude' => array(
			...
			'label' => 'Codes of the products not allowed for the slider item',
			'type' => 'string',
			'internaltype' => 'string',
			'default' => '',
			'required' => false,
