...
/**
 * Currency-limiting decorator for slider providers
 *
 * This decorator interacts with the SliderUpdate and Autofill basket plugins!
 * If the delivery/payment option isn't available any more, the SliderUpdate
	...
	implements \Aimeos\MShop\Slider\Provider\Decorator\Iface
{
	private $beConfig = array(
		'currency.include' => array(
			...
			'label' => 'List of currencies allowed for the slider item',
			'type' => 'string',
			'internaltype' => 'string',
			'default' => '',
			'required' => false,
		...
		'currency.exclude' => array(
			...
			'label' => 'List of currencies not allowed for the slider item',
			'type' => 'string',
			'internaltype' => 'string',
			'default' => '',
			'required' => false,
	...
	/**
	 * Checks if the country code is allowed for the slider provider.
	 *
