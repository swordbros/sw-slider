...
/**
 * Base decorator methods for slider provider.
 *
 * @package MShop
 * @subpackage Slider
 */
abstract class Base
	extends \Aimeos\MShop\Slider\Provider\Base
{
	private $object;
	...
	{
		return $this->object->setConfigFE( $orderSliderItem, $attributes );
	}
	 ...
	 */
	protected function getProvider() : \Aimeos\MShop\Slider\Provider\Iface
	{
		return $this->object;
	}
