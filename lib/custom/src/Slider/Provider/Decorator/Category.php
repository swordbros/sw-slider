...
/**
 * Category-limiting decorator for slider providers
 *
	...
	implements \Aimeos\MShop\Slider\Provider\Decorator\Iface
{
	private $beConfig = array(
		'category.include' => array(
			...
			'label' => 'Code of allowed category and sub-categories for the slider item',
			'type' => 'string',
			'internaltype' => 'string',
			'default' => '',
			'required' => false,
		...
		'category.exclude' => array(
			...
			'label' => 'Code of category and sub-categories not allowed for the slider item',
			'type' => 'string',
			'internaltype' => 'string',
			'default' => '',
			'required' => false,
