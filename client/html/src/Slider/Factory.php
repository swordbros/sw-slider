	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	...
	{
		/** client/html/swordbros/slider/name
		 ...
		 *
		 *  \Aimeos\Client\Html\Swordbros\Slider\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Client\Html\Swordbros\Slider\Mylist
		 *
		 * then you have to set the this configuration option:
		 *
		 *  client/html/swordbros/slider/name = Mylist
		 *
